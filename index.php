					 ...
					 <li>
						 <div class="tittle">
							 <h2>NAIKI Rental & Jasa</h2>
							  ...
							  <a class="hvr-shutter-in-horizontal" href="#">Download di Playstore</a>
						</div>
					  </li>
						<li>
						 <div class="tittle">
			 ...
			 <div class="top-menu">
				 ...
				 <nav class="cl-effect-21">
					<ul class="top-menu2">
						...
						<li><a class="scroll" href="howto/mendaftar/index.html">Cara Sewa</a></li>
		 ...
		 <div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
			 <div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
				 <a href="#small-dialog2" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
					 ...
					 <div class="tour-caption">
						 <h4>MC & Talent</h4>
						 <p>Kateggori ini dari team Naiki Rental & Jasa mencari orang yang lihai dibidang MC dan talent untuk menjual jasanya kepada para pengguna naiki rental & jasa</p>
						 <!-- <span> </span> -->
						</div>
					</a>
			 </div>
...
<div id="team" class="team">
	 <div class="container">
		 ...
		 <div class="team-grids">
			 ...
			 <div class="col-md-4 team-grid">
				 <a href="#"><img src="images/sandy.jpg" alt=""/></a>
